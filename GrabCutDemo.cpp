...
static void help()
{
    cout << "\n步骤：1、鼠标左键，画出范围。2、shit+左键画出需要的部分。3、ctrl+右键画出需要的部分\n"
...
void GCApplication::showImage() const
{
    ...
    imwrite("/Users/fly/Documents/work/WorkSpace/CWorkSpace/OpencvDemo/Demo01/test_result.jpg", res);
    imshow( *winName, res );
}
...
//{
//    
//    string filename = "/Users/fly/Documents/work/WorkSpace/CWorkSpace/OpencvDemo/Demo01/long.jpg";
